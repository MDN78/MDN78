...
<tr><td width="7%" valign="middle"><img src="assets/Niffler.PNG"></td><td valign="middle">Framework: Playwright. Project of auto-tests UI, REST API, SQLAlchemy, KAFKA, SOAP, Kafka, gRPC. Based on "Niffler" app.</br><a target="_blank" href="https://github.com/MDN78/niffler-py-st3/tree/main/niffler-e-2-e-tests-python">NIFFLER</a></td></tr>
...
<tr><td width="7%" valign="middle"><img src="assets/butterfly.png"></td><td valign="middle">Framework: "HTTPX". The project are written using Python, HTTPX, Pytest, Allure and Pydantic. </br><a target="_blank" href="https://github.com/MDN78/autotests-api">API Course auto tests</a></td></tr>
</table>
...
<table style="width: 100%; border: none;">
    ...
    <tr><td style="width: 15%; vertical-align: middle;"><img src="assets/qa_guru_black.png"></td><td style="vertical-align: middle;">QA.GURU. QA Automation Engineer Advance</br><a target="_blank" href="https://drive.google.com/file/d/1-h3tOsPqrY4FWjFSPzyMC_TKYugAra1L/view?usp=drivesdk">Certificate</a></td></tr>
