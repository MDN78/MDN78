...
<h4 align="left">Stack: </br>**Python+Pytest+Selenium+Requests+AllureReports**.</br>**Python+Pytest+Selene+AllureReports**</br>  In this case your can find my projects completed in the course of training and practice.</h4>
